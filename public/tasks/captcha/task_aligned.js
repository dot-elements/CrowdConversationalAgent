...
var task = {
    ...
    "questions": [
        ...
        {
            "id": "financial",
            "question": ["Which of the following stress management technique would you like to try?", "Most Popular: Creating a monthly budget plan has shown proven results in stress management for 82 percent of users."],
            "answers": ["Sleep 8h", "Make a monthly budget", "Download a time tracking app", "Journaling", "Reach out to a family member or a friend"]
        },
        {
            "id": "survey1",
